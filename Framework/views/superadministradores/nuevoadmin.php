                            ...
                            <div class="column container-data align-start header-content">
                                <div class="row auto">
                                    <div class="column auto">
                                        <h1 class="color-white weight-bold">Agregar Administrador</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="column full">
                            ...
                            <div class="row-responsive justify-center">
                                <div class="column superadmin-input">
                                    ...
                                    <input type="text" name="mat" placeholder="201600001"
                                ...
                                <div class="column superadmin-input">
                                    ...
                                    <input type="password" name="pas" class="input input-info-profile" required>
                                </div>
                            </div>
                            <div class="row-responsive justify-center">
                                <div class="column superadmin-input">
                                    <h4 class="color-darkgray font-regular">Email</h4>
                                    <input type="email" name="ema" placeholder="matricula@upqroo.edu.mx"
                                        class="input input-info-profile" required>
                                </div>
                                <div class="column superadmin-input">
                             ...
                             <div class="row-responsive justify-center">
                                <div class="column superadmin-input">
                                    ...
                                    <input type="text" name="nom" placeholder="Fulanito"
                                        class="input input-info-profile" required>
                                </div>
                            </div>
                            ...
                            <div class="row-responsive justify-center">
                                <button type="submit" id ="btn_save" class="btn btn-general-data bg-darkBlue color-white font-regular weight-semi">
