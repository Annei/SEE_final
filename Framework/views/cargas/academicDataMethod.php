...
<body>
    <div class="main flex" id="HTMLtoPDF">
                ...
                <div class="row-responsive ">
                    ...
                    <div class="wrap justify-center">
                        ...
                        <div class="justify-center">
                            <button type="button"class="btn btn-general-data bg-darkBlue color-white font-regular weight-semi"><a href="<?php echo constant('URL'); ?>alumnos/SEE_Carga_acádemica_PDF">Imprimir carga academica</a></button>
                        </div>
                    </div>
                </div>
            </div>
