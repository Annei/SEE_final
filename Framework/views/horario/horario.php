                        ...
                        <div class="column container-data">
                            <div class="row-responsive container-cards">
                                ...
                                <div class="column card-data justify-center">
                                    <div class="row">
                                        <div class="column align-start justify-center">
                                            <h4 class="truncate"><?php echo $this->getAcademicPeriod['clave_carrera'].$this->$this->getAcademicPeriod['carrera_nombre']?></h4>
                                            <div class="white-space-16"></div>
                           ...
                           <!--/.boton  <div class="row-responsive justify-center">
